...
while(True):
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            img2 = pygame.image.load(io.BytesIO(img), "jpg")
            pygame.image.save(img2, "./test1/image-{}.jpg".format(time.time()))
            # img2.save(folder_rainbow + "/data-{}.jpg".format(current_time), quality=100)
