...
def slice_video_to_images(video_path, output_folder):
    ...
    while cap.isOpened():
        ...
        image_path = os.path.join(output_folder, f"{count:04d}.jpg")
...
if __name__ == '__main__':
    ...
    video_path = '/home/yf/SynologyDrive/Google Drive/Job/dev/w0405_agent/data/lift-inspection/video-rear/20240426/776/video_1714145780.9333227.avi'
    output_folder = 'result/images2'
    res = slice_video_to_images(video_path, output_folder)
    print(res)
    pass
    # # Example usage
